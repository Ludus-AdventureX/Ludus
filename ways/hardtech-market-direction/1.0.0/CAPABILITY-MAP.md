# Hardtech Market Direction 1.0.0 能力地图

本文记录 `探讨/skills/research` 全部 31 个 Skill 如何沉淀到 `hardtech-market-direction@1.0.0`。它解决两个不同问题：
...
- 延后项进入新方法包时，不修改已发布的 `hardtech-market-direction@1.0.0`。
