  ...
  return (
    <>
      ...
      >
        <Link
          href="/enter"
          className="inline-flex items-center gap-2 rounded-full border border-neutral-900 bg-neutral-900 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-neutral-800"
        >
          <span>受邀进入 / 登录</span>
        </Link>
        <Link
