...
// Identity / tenancy (canonical since Task 19A; auth routes live since Task 3)
export type User = Schemas["User"];
export type UserSession = Schemas["UserSession"];
export type WorkspaceMembership = Schemas["WorkspaceMembership"];

// Auth session surface (Task 3)
export type AuthSessionEnvelope = Schemas["AuthSessionEnvelope"];
export type AuthSessionData = Schemas["AuthSessionData"];
export type UserSummary = Schemas["UserSummary"];
export type SessionSummary = Schemas["SessionSummary"];
export type MembershipSummary = Schemas["MembershipSummary"];
export type CsrfEnvelope = Schemas["CsrfEnvelope"];
export type CsrfTokenData = Schemas["CsrfTokenData"];
export type LoginRequest = Schemas["LoginRequest"];
export type RegisterRequest = Schemas["RegisterRequest"];
export type LogoutEnvelope = Schemas["LogoutEnvelope"];
