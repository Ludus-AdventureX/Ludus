...
try {
    if ($Check) {
        ...
        & uv run --python 3.12 --project services/api python scripts/export_openapi.py --output $checkOpenApi
        ...
        & uv run --python 3.12 --project services/api python scripts/export_openapi.py
